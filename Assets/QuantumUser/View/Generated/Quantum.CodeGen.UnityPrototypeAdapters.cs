...
namespace Quantum.Prototypes.Unity {
  ...
  public unsafe partial class GameplayPrototype : Quantum.QuantumUnityPrototypeAdapter<Quantum.Prototypes.GameplayPrototype> {
    ...
    [DynamicCollectionAttribute()]
    public Quantum.QuantumEntityPrototype[] RevivePositions = {};
    ...
    partial void ConvertUser(Quantum.QuantumEntityPrototypeConverter converter, ref Quantum.Prototypes.GameplayPrototype prototype);
    public override Quantum.Prototypes.GameplayPrototype Convert(Quantum.QuantumEntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.GameplayPrototype();
      converter.Convert(this.allWeaponsConfig, out result.allWeaponsConfig);
      converter.Convert(this.gameConfig, out result.gameConfig);
      converter.Convert(this.StartPositions, out result.StartPositions);
      converter.Convert(this.RevivePositions, out result.RevivePositions);
      converter.Convert(this.State, out result.State);
      converter.Convert(this.RoundState, out result.RoundState);
      converter.Convert(this.RoundEndReason, out result.RoundEndReason);
